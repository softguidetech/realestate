...
class CustomerPortal(portal.CustomerPortal):
    ...
    def portal_my_tickets1(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, search=None,
        ...
        return request.render("property_rental_mgt_app.portal_my_tickets1", values)
    ...
    def portal_my_ticket1(self, maintenance_id, access_token=None, **kw):
        ...
        return request.render("property_rental_mgt_app.portal_helpdesk_ticket_page1",
            {
    ...
    def portal_my_contracts(self, **kwargs):
        ...
        return request.render("property_rental_mgt_app.portal_my_contracts", values)
    ...
    def portal_my_contract(self, contract_id, access_token=None, **kw):
        ...
        return request.render("property_rental_mgt_app.portal_contract_page",
                              {
    ...
    def portal_my_maintenance(self, **kwargs):
        ...
        return request.render("property_rental_mgt_app.portal_my_maintenance", values)
    ...
    def create_new_maintenance(self, **kw):
        ...
        return http.request.render(
            "property_rental_mgt_app.portal_create_maintenance",
            {
    ...
    def send_maintenance_request_notification(self, maintenance_request):
        manager_group = request.env.ref('property_rental_mgt_app.group_manager').sudo()
        if manager_group:
            manager_users = manager_group.users.mapped('partner_id.email')
            if manager_users:
                template = request.env.ref('property_rental_mgt_app.maintenance_request_notification_template').sudo()
                if template:
