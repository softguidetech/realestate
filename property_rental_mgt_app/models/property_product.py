...
class ProductProduct(models.Model):
    ...
    def _compute_user_groups_not_allowed(self):
        for record in self:
            ...
            if not user.has_group('property_rental_mgt_app.group_rent_payer') and \
                    not user.has_group('property_rental_mgt_app.group_purchaser') and \
                    not user.has_group('property_rental_mgt_app.group_manager'):
