...
class His_Admission_Report_xlsx(models.AbstractModel):
    _name = 'report.realestate_sgt.units_report_xlsx'
...
class UnitReport(models.TransientModel):
    ...
    def print_units_report_xlsx(self):
        ...
        if units:
            self.env.ref(
                'realestate_sgt.reserve_units_report_xlsx').sudo().report_file = 'Units With Payment Data'
            ...
            return self.env.ref('realestate_sgt.reserve_units_report_xlsx').report_action(self,data=data)
